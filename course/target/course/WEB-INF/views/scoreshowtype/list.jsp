...
<%
	...
	//设置左侧浏览状态
	session.setAttribute("nav", "scoreshowtype");
%>
...
<body>
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">显示类型管理</div>
			...
			<table>
				<tr>
					...
					<c:if test="${pagedCourseTeachingClassHomeworkScoreShowTypeData!=null and pagedCourseTeachingClassHomeworkScoreShowTypeData.totalCount>10}">
						...
						<td><div class="btn-group" role="group" aria-label="...">
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="scoreshowtype/list.html?pageSize=10">
										...
										<li class="divider"></li>
										<li><a href="scoreshowtype/list.html?pageSize=20">
												<c:if test="${sessionScope.USER_CONTEXT.pageSize==20}">
													<i class="icon-ok"></i>
												</c:if>
												20
											</a></li>
										<li><a href="scoreshowtype/list.html?pageSize=30">
												<c:if test="${sessionScope.USER_CONTEXT.pageSize==30}">
													<i class="icon-ok"></i>
												</c:if>
												30
											</a></li>
										<li><a href="scoreshowtype/list.html?pageSize=40">
												<c:if test="${sessionScope.USER_CONTEXT.pageSize==40}">
													<i class="icon-ok"></i>
												</c:if>
												40
											</a></li>
										<li><a href="scoreshowtype/list.html?pageSize=50">
												<c:if test="${sessionScope.USER_CONTEXT.pageSize==50}">
													<i class="icon-ok"></i>
												</c:if>
												50
											</a></li>
										<li><a href="scoreshowtype/list.html?pageSize=60">
												<c:if test="${sessionScope.USER_CONTEXT.pageSize==60}">
													<i class="icon-ok"></i>
												</c:if>
												60
											</a></li>
										<li><a href="scoreshowtype/list.html?pageSize=70">
												<c:if test="${sessionScope.USER_CONTEXT.pageSize==70}">
													<i class="icon-ok"></i>
												</c:if>
												70
											</a></li>
										<li><a href="scoreshowtype/list.html?pageSize=80">
												<c:if test="${sessionScope.USER_CONTEXT.pageSize==80}">
													<i class="icon-ok"></i>
												</c:if>
												80
											</a></li>
										<li><a href="scoreshowtype/list.html?pageSize=90">
										...
										<li><a
												href="scoreshowtype/list.html?pageSize=100">
										...
										<li class="divider"></li>
										<li><a
												href="scoreshowtype/list.html?pageSize=1000">
												<c:if test="${sessionScope.USER_CONTEXT.pageSize>100}">
													<i class="icon-ok"></i>
												</c:if>
												不分页
			...
			<c:choose>
				<c:when test="${pagedCourseTeachingClassHomeworkScoreShowTypeData.totalCount >0}">
					...
					<div class="Course-Table">
						...
						<div class="container-fluid">
							...
							<c:forEach var="dataitem" items="${pagedCourseTeachingClassHomeworkScoreShowTypeData.result}">
								<div class="row">
									<div class="col-md-1">
										<input type="checkbox" value="">
										${(pagedCourseTeachingClassHomeworkScoreShowTypeData.currentPageNo-1) * pagedCourseTeachingClassHomeworkScoreShowTypeData.pageSize +index}
									</div>
						...
						<mathtop:PageBar pageUrl="/scoreshowtype/list.html" pageAttrKey="pagedCourseTeachingClassHomeworkScoreShowTypeData" />
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">添加显示类型</h4>
				</div>



				<form class="form-horizontal" action="<c:url value="/scoreshowtype/add.html"/>"
					method="post">


					<div class="modal-body">
						<h4 class="form-signin-heading">请输入显示类型</h4>

						<div class="form-group">
							<label for="name" class="col-sm-4 control-label">名称</label>
							<div class="col-sm-8">
								<input type="text" id="name" class="form-control" name="name"
									placeholder="显示类型名称" required autofocus>
							</div>
						</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">修改显示类型</h4>
				</div>

				<form class="form-signin" action="<c:url value='/scoreshowtype/update.html'/>"
					method="post">


					<div class="modal-body">
						<input type="hidden" id="id" name="id">
						<h4 class="form-signin-heading">请修改显示类型属性</h4>
						<div class="form-group">
	...
	<script>
		...
		function onUpdate(id, name, note) {
			var url = "location='<c:url value="/scoreshowtype/update.html"/>'";
		...
		function onDelete(id, name, note) {
			var url = "location='<c:url value="/scoreshowtype/delete-"/>"
					+ id + ".html'";
