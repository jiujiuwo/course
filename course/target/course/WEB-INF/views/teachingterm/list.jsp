...
<body>
		...
		<div class="DocumentPageRightArea">
			...
			<table>
				<tr>
					...
					<c:if test="${pagedCourseTeachingTerm!=null and pagedCourseTeachingTerm.totalCount>10}">
	...
	<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value='/courseteachingterm/update.html'/>"
					method="post">
	...
	<script>
		...
		function onUpdate(id, begin_year, end_year, term, weeks, week_begin) {
			...
			$('#updateModal').find('.modal-body #teaching_year_begin').val(
					begin_year);
			$('#updateModal').find('.modal-body #teaching_year_end').val(
					end_year);
