			...
			<c:if test="${fn:contains(flag,'score')}">
				...
				<div class="panel panel-default">
					...
					<div id="collapseScore"
						class="panel-collapse collapse <%=isCollapse((String) session.getAttribute("nav"), "scoremarkingtype,scoreshowtype")%>"
						role="tabpanel" aria-labelledby="headingScore">
						<div class="panel-body">
							<div class="list-group">
								<a href="scoremarkingtype/list.html"
									class="list-group-item <%=nav((String) session.getAttribute("nav"), "scoremarkingtype")%>">分值类型</a>
									<a href="scoreshowtype/list.html"
									class="list-group-item <%=nav((String) session.getAttribute("nav"), "scoreshowtype")%>">显示类型</a>
							...
							<div class="list-group">
								...
								<c:forEach var="dataitem"
									...
									<a
										...
										href="<c:url value="/coursecontent/index-${dataitem.courseTeachingClass.id}.html"/>">${dataitem.course.name }(${dataitem.term.teachingYearBegin }-${dataitem.term.teachingYearEnd }-${dataitem.term.teachingTerm })</a>
								</c:forEach>
