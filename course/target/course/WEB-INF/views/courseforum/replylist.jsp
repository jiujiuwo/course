									...
									<div class="row"
										...
										<div class="col-md-12">
											<p>
												...
												(
												<fmt:formatDate value="${selectedCourseForumTopicViewData.forumtopic.createdDate}"
													pattern="yyyy-MM-dd HH:mm:ss" />
												)

												<c:if
													test="${selectedCourseForumTopicViewData.userbasicinfoviewdata.user.id!=sessionScope.USER_CONTEXT.user.id}">
													<button type="button" class="btn btn-default btn-xs"
											...
											<c:if test="${fn:length(selectedCourseForumTopicViewData.topicFileList)>0}">

												<div class="gridseparator"></div>
												<c:choose>

													<c:when test="${fn:length(selectedCourseForumTopicViewData.topicFileList)==1}">
														<a
													...
													<c:otherwise>
														<ul>
															<c:forEach var="datafile" items="${selectedCourseForumTopicViewData.topicFileList}">
																<li><a
									...
									<div class="row"
										...
										<div class="col-md-12">
											<p>
												...
												<fmt:formatDate value="${data.forumreply.createdDate}" pattern="yyyy-MM-dd HH:mm:ss" />
												)
											</p>
											<div id="reply${data.forumreply.id}">${data.forumreply.content}</div>
