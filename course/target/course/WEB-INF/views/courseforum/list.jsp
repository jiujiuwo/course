		...
		<div class="DocumentPageRightArea">
			...
			<table>
				<tr>
					...
					<c:if test="${pagedForumTopicViewData!=null and pagedForumTopicViewData.totalCount>10}">
						<td style="width: 10px;"></td>
						<td><div class="btn-group" role="group" aria-label="...">
								<!-- Split button -->
								<div class="btn-group">
			...
			<div class="Course-Table">
				...
				<div class="container-fluid" style="overflow: hidden;">
					...
					<c:forEach var="data" items="${pagedForumTopicViewData.result}">
						<div class="row show-grid">
							...
							<div class="col-md-2">
								<fmt:formatDate value="${data.forumtopic.createdDate}" pattern="yyyy-MM-dd HH:mm:ss" />

							</div>
							<div class="col-md-2">
								<fmt:formatDate value="${data.forumtopic.lastModifiedDate}" pattern="yyyy-MM-dd HH:mm:ss" />
				...
				<c:if test="${not empty selectedCourseTeachingClassID}">
					<mathtop:PageBar pageUrl="/courseforum/list-${selectedCourseTeachingClassID}.html"
