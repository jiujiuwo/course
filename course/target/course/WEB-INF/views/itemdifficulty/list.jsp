...
<%
	...
	//设置左侧浏览状态
	session.setAttribute("nav", "itemdifficulty");
%>
...
<body>
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">题目难度管理</div>
			...
			<div class="Course-Table">
				...
				<table class="table table-hover table-bordered"
					...
					<tbody>
						...
						<c:forEach var="dataitem" items="${pagedItemDifficulty.result}">
							<tr>
								<th scope="row"><input type="checkbox" value="">
									${(pagedItemDifficulty.currentPageNo-1) * pagedItemDifficulty.pageSize +index}</th>
								<td>${dataitem.name}</td>
								<td>${dataitem.note}</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">添加题目难度</h4>
				</div>
				...
				<form class="form-signin" action="<c:url value="/${pagedURI}/add.html"/>"
					...
					<div class="modal-body">
						<h4 class="form-signin-heading">请输入新加题目难度名称</h4>
						<label for="inputname" class="sr-only">题目难度名称</label> <input
							type="text" id="inputname" class="form-control" name="name"
							placeholder="题目难度名称" required autofocus> <label
							for="inputnote" class="sr-only">题目难度描述</label> <input type="text"
