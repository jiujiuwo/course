...
<%
	...
	//设置左侧浏览状态
	session.setAttribute("nav", "coursestyle");
%>
...
<body>
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">课程类别管理</div>
			...
			<table>
				<tr>
					...
					<c:if test="${pagedCourseStyle!=null and pagedCourseStyle.totalCount>10}">
						<td style="width: 10px;"></td>
						<td><div class="btn-group" role="group" aria-label="...">
								<!-- Split button -->
								<div class="btn-group">
			...
			<div class="Course-Table">
				...
				<table class="table table-hover table-bordered" style="margin-bottom: -10px;">
					...
					<tbody>
						...
						<c:forEach var="dataitem" items="${pagedCourseStyle.result}">
							<tr>
								<th scope="row"><input type="checkbox" value="">
									${(pagedCourseStyle.currentPageNo-1) * pagedCourseStyle.pageSize +index}</th>
								<td>${dataitem.name}</td>
								<td>${dataitem.note}</td>
			...
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value="/${pagedURI}/add.html"/>" method="post">
					...
					<div class="modal-body">
						<h4 class="form-signin-heading">请输入新加课程类别名称</h4>
						<label for="inputname" class="sr-only">课程类别名称</label>
						<input type="text" id="inputname" class="form-control" name="name" placeholder="课程类别名称"
							required autofocus>
						<label for="inputnote" class="sr-only">课程类别描述</label>
						<input type="text" id="inputnote" class="form-control" name="note" placeholder="课程类别描述">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value='/${pagedURI}/update.html'/>" method="post">
					...
					<div class="modal-body">
						<h4 class="form-signin-heading">请修改课程类别属性</h4>
						<label for="inputname" class="sr-only">课程类别名称</label>
						...
						<input type="text" id="inputname" class="form-control" name="name" value=""
							placeholder="课程类别名称" required autofocus>
						<label for="inputnote" class="sr-only">课程类别描述</label>
