		...
		<div class="DocumentPageRightArea">
			...
			<table>
				<tr>
					...
					<c:if test="${pagedDeparment!=null and pagedDeparment.totalCount>10}">
						<td style="width: 10px;"></td>
						<td><div class="btn-group" role="group" aria-label="...">
								<!-- Split button -->
								<div class="btn-group">
	...
	<script>
		...
		function onSearch() {
			...
			if (st != null && st.trim().length > 0) {
				var url = "<c:url value='/department'/>" + "/select-" + st
						+ ".html";
		...
		function onUpdate(id, name, note) {
			var url = "location='<c:url value="/department/update-"/>" + id
					+ ".html'";
		...
		function onDelete(t_department_id, departmentname) {
			...
			var url = "location='<c:url value="/department/DELETE-"/>"
					+ t_school_id + "-" + t_department_id + ".html'";
