	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<p class="text-muted">
				...
				<c:forEach var="t" items="${pagedTeachingClassViewData.result[0].teacher}" varStatus="status">
			...
			<c:choose>
				<c:when test="${pagedTeacherCount >0}">
						...
						<tr>
							...
							<td><div class="btn-group" role="group" aria-label="...">
									<button type="button" class="btn btn-default btn-sm" data-toggle="modal"
										data-target="#addModal">增加授课教师</button>
					...
					<form class="form-horizontal" style="overflow: hidden;"
						action="<c:url value="/teachingclass/addteacher2teachingclass.html"/>" method="post">
								...
								<div class="Course-Table">
									...
									<table id="teachertable" class="table table-hover table-bordered">
										...
										<tbody>
											...
											<c:forEach var="dataitem" items="${pagedTeachingClassViewData.result[0].teacher}"
												varStatus="status">
												<tr id="teacherrow${dataitem.teacher.id}">
													<th scope="row"><input type="checkbox" value=""> ${index}</th>

													<td>${dataitem.school.name}</td>
													<!-- 授课教师 -->
													<td><input id='teacherid' name='teacherid' value='${dataitem.teacher.id}'
															type='hidden' />
													...
													<td><input id='teachingtypeid' name='teachingtypeid'
															...
															type='hidden' />
														${pagedTeachingClassViewData.result[0].teachingtype[status.index].name}</td>
									...
									<c:if test="${not empty selectedTeachingClassID}">
										<mathtop:PageBar pageUrl="/teachingclass/student-${selectedTeachingClassID}.html"
	...
	<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="container-fluid" style="overflow: hidden;">
						...
						<div class="row">
							...
							<div class="col-md-10">
								<select id="teachingtypeSelectControlAdd" class="form-control" name="teachingtypeId">
									<c:forEach var="t" items="${pagedTeachingType.result}">
										<option value="${t.id}">${t.name}</option>
									</c:forEach>
								</select>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary" onclick="AddTeacherRow()">确定</button>
