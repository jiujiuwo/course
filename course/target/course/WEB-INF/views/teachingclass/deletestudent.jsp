	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<form class="form-horizontal" style="overflow: hidden;"
				action="<c:url value="/teachingclass/dodeletestudent-${selectedCourseTeachingClassViewData.courseTeachingClass.id }-${selectedStudentViewData.student.id }-${selectedpageNo}.html"/>"
				method="post">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<p class="form-control-static">${selectedCourseTeachingClassViewData.courseTeachingClass.name }</p>
					...
					<div class="col-md-1">
						<p class="form-control-static">${selectedCourseTeachingClassViewData.term.teachingYearBegin }-${selectedCourseTeachingClassViewData.term.teachingYearEnd }</p>
					</div>
					...
					<div class="col-md-1">
						<p class="form-control-static">${selectedCourseTeachingClassViewData.term.teachingTerm }</p>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<p class="form-control-static">${selectedCourseTeachingClassViewData.courseTeachingClass.name }
						</p>
					</div>
				</div>
				...
				<div class="form-group">
				<div class="alert alert-danger" role="alert">警告！删除该学生后，该学生在${selectedCourseTeachingClassViewData.courseTeachingClass.name }中包括作业、考勤等信息被全部删除！</div>
