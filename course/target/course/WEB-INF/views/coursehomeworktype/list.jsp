...
<%
	...
	//设置左侧浏览状态
	session.setAttribute("nav", "coursehomeworktype");
%>
...
<body>
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">课程作业类型管理</div>
			...
			<table>
				<tr>
					...
					<c:if test="${pagedHomeworkTypeData!=null and pagedHomeworkTypeData.totalCount>10}">
						<td style="width: 10px;"></td>
						<td><div class="btn-group" role="group" aria-label="...">
								<!-- Split button -->
								<div class="btn-group">
			...
			<div class="Course-Table">
				...
				<div class="container-fluid" style="overflow: hidden;">
					...
					<c:forEach var="data" items="${pagedHomeworkTypeData.result}">
						<div class="row show-grid">
							<div class="col-md-1">
								...
								${(pagedHomeworkTypeData.currentPageNo-1) * pagedHomeworkTypeData.pageSize +index}
							</div>
					...
					<c:if test="${pagedHomeworkTypeData.totalCount>0}">
						<div class="gridseparator"></div>
					</c:if>
				...
				<mathtop:PageBar pageUrl="/homeworktype/list.html-${selectedCourseTeachingClassID}"
					pageAttrKey="pagedHomeworkTypeData" />
				...
				<form class="form-signin"
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" id="inputname" class="form-control" name="name" placeholder="课程作业类型名称"
								required autofocus>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" id="inputnote" class="form-control" name="note" placeholder="课程作业类型描述">
						</div>
			...
			<div class="modal-content">
				...
				<form class="form-signin"
					...
					<div class="modal-body">
						...
						<label for="inputname" class="sr-only">课程作业类型名称</label>
						...
						<input type="text" id="inputname" class="form-control" name="name" value=""
							placeholder="课程作业类型名称" required autofocus>
						<label for="inputnote" class="sr-only">课程作业类型描述</label>
