		...
		<div class="DocumentPageRightArea">
			...
			<table>
				<tr>
					...
					<c:if test="${pagedAttendanceTypeData!=null and pagedAttendanceTypeData.totalCount>10}">
						<td style="width: 10px;"></td>
						<td><div class="btn-group" role="group" aria-label="...">
								<!-- Split button -->
								<div class="btn-group">
			...
			<div class="Course-Table">
				...
				<mathtop:PageBar pageUrl="/school/list.html" pageAttrKey="pagedAttendanceTypeData" />
				...
				<form class="form-signin"
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" id="inputname" class="form-control" name="name" placeholder="考勤类型名称"
								required autofocus>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" id="inputnote" class="form-control" name="note" placeholder="考勤类型描述">
						</div>
			...
			<div class="modal-content">
				...
				<form class="form-signin"
					...
					<div class="modal-body">
						...
						<label for="inputname" class="sr-only">考勤类型名称</label>
						...
						<input type="text" id="inputname" class="form-control" name="name" value=""
							placeholder="考勤类型名称" required autofocus>
						<label for="inputnote" class="sr-only">考勤类型描述</label>
