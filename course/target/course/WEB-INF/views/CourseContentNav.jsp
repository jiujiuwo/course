...
<div class="NavPanel-Group" id="accordion">
	...
	<div class="NavPanel">
		...
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			...
			<c:if test="${sessionScope.USER_CONTEXT.teacher!=null}">
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingHomeworkScoreInfoManager">
						<h4 class="panel-title">
							<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
							<a class="collapsed" data-toggle="collapse" data-parent="#accordion"
								href="#collapseHomeworkScoreInfoManager" aria-expanded="false" aria-controls="collapseHomeworkScoreInfoManager">
								成绩设置</a>
						</h4>
					</div>
					<div id="collapseHomeworkScoreInfoManager"
						class="panel-collapse collapse <%=iscourseCollapse((String) session.getAttribute("nav"), "coursehomeworkscoreinfo")%>"
						role="tabpanel" aria-labelledby="headingHomeworkScoreInfoManager">
						<div class="panel-body">
							<div class="list-group">
								...
								<c:forEach var="data" items="${pagedHomeworkTypeData.result}">
									...
									<a id="homeworkscoreinfo${data.id}"
										href="coursehomeworkscoreinfo/list-${selectedCourseTeachingClassID}-${data.id}.html"
										class="list-group-item ">${data.name}</a>
			...
			<c:if test="${sessionScope.USER_CONTEXT.teacher!=null}">
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingHomeworkScoreManager">
						<h4 class="panel-title">
							<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
							<a class="collapsed" data-toggle="collapse" data-parent="#accordion"
								href="#collapseHomeworkScoreManager" aria-expanded="false" aria-controls="collapseHomeworkScoreManager">
								课程成绩</a>
						</h4>
					</div>
					<div id="collapseHomeworkScoreManager"
						class="panel-collapse collapse <%=iscourseCollapse((String) session.getAttribute("nav"), "coursehomeworkscore")%>"
						role="tabpanel" aria-labelledby="headingHomeworkScoreManager">
						<div class="panel-body">
							<div class="list-group">
								...
								<c:forEach var="data" items="${pagedHomeworkTypeData.result}">
									...
									<a id="coursehomeworkscore${data.id}"
										href="coursehomeworkscore/list-${selectedCourseTeachingClassID}-${data.id}.html"
										class="list-group-item ">${data.name}</a>
			...
			<c:if test="${sessionScope.USER_CONTEXT.student!=null}">
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingHomeworkScore">
						<h4 class="panel-title">
							<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
							<a class="collapsed" data-toggle="collapse" data-parent="#accordion"
								href="#collapseHomeworkScore" aria-expanded="false" aria-controls="collapseHomeworkScore">
								课程成绩</a>
						</h4>
					</div>
					<div id="collapseHomeworkScore"
						class="panel-collapse collapse <%=iscourseCollapse((String) session.getAttribute("nav"), "coursehomeworkscore")%>"
						role="tabpanel" aria-labelledby="headingHomeworkScore">
						<div class="panel-body">
							<div class="list-group">
								...
								<c:forEach var="data" items="${pagedHomeworkTypeData.result}">
									...
									<a id="coursehomeworkscore${data.id}"
										href="coursehomeworkscore/studentlist-${selectedCourseTeachingClassID}-${data.id}.html"
										class="list-group-item ">${data.name}</a>
