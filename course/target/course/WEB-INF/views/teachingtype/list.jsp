		...
		<div class="DocumentPageRightArea">
			...
			<table>
				<tr>
					...
					<c:if test="${pagedTeachingType!=null and pagedTeachingType.totalCount>10}">
			...
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value="/${pagedURI}/add.html"/>" method="post">
					...
					<div class="modal-body">
						...
						<input type="text" id="inputname" class="form-control" name="name" placeholder="教师授课类型名称"
							required autofocus>
						<label for="inputnote" class="sr-only">教师授课类型描述</label>
						<input type="text" id="inputnote" class="form-control" name="note" placeholder="教师授课类型描述">
