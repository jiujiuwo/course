...
<body>
				...
				<tr>
					...
					<td><div class="btn-group" role="group" aria-label="...">
							<button type="button" class="btn btn-default btn-sm"
								onclick="window.location.href='<c:url value="/course/add.html"/>'">增加</button>
					...
					<c:if test="${pagedCourseViewData!=null and pagedCourseViewData.totalCount>10}">
						<td style="width: 10px;"></td>
						<td><div class="btn-group" role="group" aria-label="...">
								<!-- Split button -->
								<div class="btn-group">
	...
	<script>
		...
		function onDelete(id, name) {
			var url = "location='<c:url value="course/delete-"/>" + id
					+ ".html'";
