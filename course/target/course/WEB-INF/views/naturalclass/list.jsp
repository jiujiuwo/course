...
<body>
		...
		<div class="DocumentPageRightArea">
			...
			<table>
				<tr>
					...
					<c:if
						test="${pagedDepartmentNaturalClassViewData!=null and pagedDepartmentNaturalClassViewData.totalCount>10}">
						<td style="width: 10px;"></td>
						<td><div class="btn-group" role="group" aria-label="...">
								<!-- Split button -->
								<div class="btn-group">
					...
					<div class="Course-Table">
						...
						<table class="table table-hover table-bordered" style="margin-bottom: -10px;">
							...
							<tbody>
								...
								<c:forEach var="dataitem" items="${pagedDepartmentNaturalClassViewData.result}">
									<tr>
				...
				<c:otherwise>
					...
					<div class="alert alert-warning alert-dismissible fade in" role="alert" style="margin: 10px;">
						...
						<div class="list-group">
							...
							<a href="#" class="list-group-item" data-toggle="modal" data-target="#addModal">添加自然班</a>
	...
	<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value="/naturalclass/add.html"/>" method="post">
					...
					<div class="modal-body">
						...
						<div class="container-fluid" style="overflow: hidden;">
							...
							<div class="row">
								...
								<div class="col-md-10">
									<select id="DepartmentSelectControlAdd" class="form-control" name="t_department_id">
										<c:forEach var="d" items="${pagedDepartment.result}">
											<option value="${d.id}">${d.name}</option>
										</c:forEach>
									</select>
							...
							<div class="row">
								...
								<div class="col-md-10">
									<input type="text" id="inputname" class="form-control" name="naturalclassname"
										placeholder="自然班名称" required autofocus>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-10">
									<input type="text" id="inputnote" class="form-control" name="naturalclassnote"
										placeholder="自然班描述">
								</div>
							</div>
			...
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value='/${pagedURI}/update.html'/>" method="post">
					...
					<div class="modal-body">
						...
						<label for="inputname" class="sr-only">自然班名称</label>
						...
						<input type="text" id="inputname" class="form-control" name="name" value=""
							placeholder="自然班名称" required autofocus>
						<label for="inputnote" class="sr-only">自然班描述</label>
	...
	<script>
		...
		function onAdd() {
			...
			$('#addModal').find('.modal-body #SchoolSelectControlAdd').val(
					schoolid);

			$('#addModal').find('.modal-body #DepartmentSelectControlAdd').val(
					departmentid);
