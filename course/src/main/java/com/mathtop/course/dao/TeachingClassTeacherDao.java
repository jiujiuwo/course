...
@Repository
public class TeachingClassTeacherDao extends BaseDao<CourseTeachingClassTeacher> {
	...
	private final String DELETE_BY_TEACHING_INFO_IDS = "DELETE FROM t_teaching_class_teacher WHERE t_course_teaching_class_id=? and t_teacher_id=? and t_teaching_type_id=?";
	/* 增加 */
