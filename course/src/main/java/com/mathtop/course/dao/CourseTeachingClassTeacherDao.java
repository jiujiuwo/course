...
public class CourseTeachingClassTeacherDao extends BaseDao<CourseTeachingClassTeacher> {
	...
	private final String DELETE_BY_COURSE_TEACHING_CLASS_ID_AND_TEACHER_ID_AND_TEACHING_TYPE_ID = "DELETE FROM t_course_teaching_class_teacher WHERE t_course_teaching_class_id=? and t_teacher_id=? and t_teaching_type_id=?";
	private final String DELETE_BY_COURSE_TEACHING_CLASS_ID_AND_TEACHER_ID = "DELETE FROM t_course_teaching_class_teacher WHERE t_course_teaching_class_id=? and t_teacher_id=?";
	...
	public String add(String t_course_teaching_class_id, String t_teacher_id, String t_teaching_type_id) {
		...
		if (IsTeacherExist(t_course_teaching_class_id, t_teacher_id, t_teaching_type_id) > 0)
			return null;
		...
		Object params[] = new Object[] { id, t_course_teaching_class_id, t_teacher_id, t_teaching_type_id };
	 ...
	 */
	public void deleteByCourseTeachingClassIdAndTeacherIdAndTeachingTypeId(String t_course_teaching_class_id,
	...
	List<CourseTeachingClassTeacher> getTeachingClassTeacherById(String id) {
		...
		getJdbcTemplate().query(GET_TEACHING_CLASS_TEACHER_BY_ID, new Object[] { id }, new RowCallbackHandler() {

			@Override
			public void processRow(ResultSet rs) throws SQLException {
				CourseTeachingClassTeacher tct = new CourseTeachingClassTeacher();
				tct.setId(id);
				tct.setTeacherId(rs.getString("t_teacher_id"));
				tct.setCourseTeachingClassId(rs.getString("t_course_teaching_class_id"));
				tct.setTeachingTypeId(rs.getString("t_teaching_type_id"));
	...
	List<CourseTeachingClassTeacher> getTeachingClassTeacherByTeachingClassId(String t_course_teaching_class_id) {
		List<CourseTeachingClassTeacher> list = new ArrayList<CourseTeachingClassTeacher>();
		getJdbcTemplate().query(GET_TEACHING_CLASS_TEACHER_BY_TEACHING_CLASS_ID,
				new Object[] { t_course_teaching_class_id }, new RowCallbackHandler() {
					...
					public void processRow(ResultSet rs) throws SQLException {
						...
						tct.setTeacherId(rs.getString("t_teacher_id"));
						tct.setCourseTeachingClassId(t_course_teaching_class_id);
						tct.setTeachingTypeId(rs.getString("t_teaching_type_id"));
	...
	public List<CourseTeachingClassTeacher> getTeachingClassTeacherByTeacherId(String t_teacher_id) {
		List<CourseTeachingClassTeacher> list = new ArrayList<CourseTeachingClassTeacher>();
		getJdbcTemplate().query(GET_TEACHING_CLASS_TEACHER_BY_TEACHER_ID, new Object[] { t_teacher_id },
	...
	public Page<TeacherViewData> getTeacherPage(String t_course_teaching_class_id) {
		List<CourseTeachingClassTeacher> listteacher = getTeachingClassTeacherByTeachingClassId(
		...
		for (CourseTeachingClassTeacher t : listteacher) {
			TeacherViewData tvd = teacherviewdataDao.getTeacherViewDataById(t.getTeacherId());
			data.add(tvd);
		}
	...
	long IsTeacherExist(String t_course_teaching_class_id, String t_teacher_id, String t_teachingtype_id) {
		...
		return getJdbcTemplate().queryForObject(IS_TEACHER_EXIST,
