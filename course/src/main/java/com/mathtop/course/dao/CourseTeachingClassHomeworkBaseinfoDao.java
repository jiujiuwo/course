...
public class CourseTeachingClassHomeworkBaseinfoDao extends BaseDao<CourseTeachingClassHomeworkBaseinfo> {
	...
	public void update(String id, String t_course_teaching_class_id, String t_teacher_id, String t_course_teaching_class_homework_type_id,
		...
		Object params[] = new Object[] { t_course_teaching_class_id, t_teacher_id, t_course_teaching_class_homework_type_id, 
	...
	public void update(String id, String t_teacher_id, Integer flag, String file_requirement, String title,
		...
		Object params[] = new Object[] { t_teacher_id, flag, file_requirement, title, content, enddate, id };
	...
	public String add(String t_course_teaching_class_id, String t_teacher_id, String t_course_teaching_class_homework_type_id,
		...
		Object params[] = new Object[] { id, t_course_teaching_class_id, t_teacher_id, t_course_teaching_class_homework_type_id, 
	...
	public CourseTeachingClassHomeworkBaseinfo getByID(String id) {
		...
		getJdbcTemplate().query(GET_BY_ID, new Object[] { id }, new RowCallbackHandler() {
			...
			public void processRow(ResultSet rs) throws SQLException {
				...
				homeworkbaseinfo.setCourseTeachingClassHomeworkTypeId(rs.getString("t_course_teaching_class_homework_type_id"));
	...
	public List<String> PageQuery(String t_course_teaching_class_id,
