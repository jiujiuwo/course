...
public class NaturalClassStudentDao extends BaseDao<NaturalClassStudent> {
	...
	private final String GET_NATURAL_CLASS_ID_BY_STUDENT_ID = "SELECT id,t_natural_class_id "
			+ "FROM t_natural_class_student " + "WHERE t_student_id=?";
	...
	public String add(String t_natural_class_id, String t_student_id) {
		...
		Object params[] = new Object[] { newid, t_natural_class_id, t_student_id };
	...
	public NaturalClassStudent getNaturalClassStudentByStudentId(String t_student_id) {
		...
		getJdbcTemplate().query(GET_NATURAL_CLASS_ID_BY_STUDENT_ID, params, types, new RowCallbackHandler() {
	...
	public List<String> getStudentIdByNaturalClassId(String t_natural_class_id) {
		...
		getJdbcTemplate().query(GET_STUDENTID_BY_NATURAL_CLASS_ID, params, types, new RowCallbackHandler() {
	...
	public School getSchoolByStudentId(String t_student_id) {
		...
		if (ncs != null) {
			DepartmentNaturalClass ncst = naturalclassschoolDao.getByNaturalclassId(ncs.getNaturalClassId());
			if (ncst != null) {
	...
	public boolean isStudentExist(String t_natural_class_id, String t_student_num) {
		return getJdbcTemplate().queryForObject(GET_COUNT_ID_BY_NATURAL_CLASS_ID_STUDENT_NUM,
