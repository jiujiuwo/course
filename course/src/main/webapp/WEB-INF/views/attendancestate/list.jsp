		...
		<div class="DocumentPageRightArea">
			...
			<div class="Course-Table">
				...
				<mathtop:PageBar pageUrl="/${pagedURI}/list.html"
					pageAttrKey="pagedAttendanceState" />
	...
	<div class="modal fade" id="addModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value="/attendancestate/add.html"/>"
					method="post">


					<div class="modal-body">
						<h4 class="form-signin-heading">请输入新加考勤状况名称</h4>
						<label for="inputname" class="sr-only">考勤状况名称</label> <input
							type="text" id="inputname" class="form-control" name="name"
							placeholder="考勤状况名称" required autofocus> <label
							for="inputnote" class="sr-only">考勤状况描述</label> <input type="text"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-signin"
					action="<c:url value="/attendancestate/update.html"/>" method="post">
					...
					<div class="modal-body">
						...
						<label for="inputname" class="sr-only">考勤状况名称</label> <input
							...
							type="text" id="inputname" class="form-control" name="name"
							value="" placeholder="考勤状况名称" required autofocus> <label
							for="inputnote" class="sr-only">考勤状况描述</label> <input type="text"
...
<%@ include file="../../shared/sysLastInclude.jsp"%>
	...
	<script>
		...
		function onUpdate(id, name, note) {
			var url = "location='<c:url value="/attendancestate/update-"/>" + id + ".html'";
		...
		function onDelete(id, name) {
			var url = "location='<c:url value="/attendancestate/DELETE-"/>" + id + ".html'";
