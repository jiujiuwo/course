...
<%
	...
	//设置左侧浏览状态
	session.setAttribute("nav", "examinationtype");
%>
...
<body class="home" onLoad="ShowErrMsg()">
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">考试类型管理</div>
			...
			<div class="Course-Table">
				...
				<table class="table table-hover table-bordered"
					...
					<tbody>
						...
						<c:forEach var="dataitem" items="${pagedExaminationType.result}">
							<tr>
								<th scope="row"><input type="checkbox" value="">
									${(pagedExaminationType.currentPageNo-1) * pagedExaminationType.pageSize +index}</th>
								<td>${dataitem.name}</td>
								<td>${dataitem.note}</td>
				...
				<mathtop:PageBar pageUrl="/${pagedURI}/list.html"
					pageAttrKey="pagedExaminationType" />
