			...
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value="/${pagedURI}/add.html"/>"
					...
					<div class="modal-body">
						...
						<label for="inputname" class="sr-only">课程类别名称</label> <input
							type="text" id="inputname" class="form-control" name="name"
							placeholder="课程类别名称" required autofocus> <label
							for="inputnote" class="sr-only">课程类别描述</label> <input type="text"
				...
				<form class="form-signin"
					...
					<div class="modal-body">
						...
						<label for="inputname" class="sr-only">课程类别名称</label> <input
							...
							type="text" id="inputname" class="form-control" name="name"
							value="" placeholder="课程类别名称" required autofocus> <label
							for="inputnote" class="sr-only">课程类别描述</label> <input type="text"
