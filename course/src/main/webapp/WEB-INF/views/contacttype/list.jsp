...
<body class="home" onLoad="ShowErrMsg()">
	...
	<div class="modal fade" id="addModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value="/contacttype/add.html"/>"
					method="post">


					<div class="modal-body">
						<h4 class="form-signin-heading">请输入新加联系类型名称</h4>
						<label for="inputname" class="sr-only">联系类型名称</label> <input
							type="text" id="inputname" class="form-control" name="name"
							placeholder="联系类型名称" required autofocus> <label
							for="inputnote" class="sr-only">联系类型描述</label> <input type="text"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-signin"
					action="<c:url value="/contacttype/update.html"/>" method="post">
					...
					<div class="modal-body">
						...
						<label for="inputname" class="sr-only">联系类型名称</label> <input
							...
							type="text" id="inputname" class="form-control" name="name"
							value="" placeholder="联系类型名称" required autofocus> <label
							for="inputnote" class="sr-only">联系类型描述</label> <input type="text"
	...
	<script>
		...
		function onUpdate(id, name, note) {
			var url = "location='<c:url value="/contacttype/update-"/>" + id + ".html'";
		...
		function onDelete(id, name) {
			var url = "location='<c:url value="/contacttype/DELETE-"/>" + id + ".html'";
