		...
		<div class="DocumentPageRightArea">
			...
			<div role="tabpanel" style="overflow: hidden;">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">操作</a></li>
			...
			<div class="Course-Table">
				...
				<table class="table table-hover table-bordered"
					...
					<tbody>
						...
						<c:forEach var="dataitem" items="${pagedPermissionOperator.result}">
							<tr>
								<th scope="row"><input type="checkbox" value="">
									${(pagedPermissionOperator.currentPageNo-1) * pagedPermissionOperator.pageSize +index}</th>
								<td>${dataitem.name}</td>
								<td>${dataitem.note}</td>
				...
				<mathtop:PageBar pageUrl="/${pagedURI}/list.html"
					pageAttrKey="pagedPermissionOperator" />
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">添加权限操作</h4>
				</div>



				<form class="form-signin" action="<c:url value="/${pagedURI}/add.html"/>"
					method="post">


					<div class="modal-body">
						<h4 class="form-signin-heading">请输入新加权限操作名称</h4>
						<label for="inputname" class="sr-only">权限操作名称</label> <input
							type="text" id="inputname" class="form-control" name="name"
							placeholder="权限操作名称" required autofocus> <label
							for="inputnote" class="sr-only">权限操作描述</label> <input type="text"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">修改权限操作</h4>
				</div>
