...
<body class="home">
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">修改教师密码</div>
			...
			<form class="form-horizontal" style="overflow: hidden;"
				...
				<input type="hidden" name="t_school_id"
					value="${selectedt_school_id }"> 

				
					
					<input type="hidden" name="t_user_id"
					value="${selectedTeacherViewData.user.id}">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<p class="form-control-static">${selectedTeacherViewData.school.name }</p>
					</div>

					<label for="departmentSelectControl" class="col-sm-1 control-label">系部</label>
					<div class="col-md-3">
						<p class="form-control-static">${selectedTeacherViewData.department.name}</p>
					</div>
				...
				<div class="form-group">
					<label for="student_num" class="col-sm-1 control-label">工号</label>
					<div class="col-md-3">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input name="user_password"
							class="form-control placeholder-no-fix" value="${selectedTeacherViewData.teacher.teacher_num }"
