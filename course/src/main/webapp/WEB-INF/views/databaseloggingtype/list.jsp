...
<%
	...
	//设置左侧浏览状态
	session.setAttribute("nav", "databaseloggingtype");
%>
...
<body class="home" onLoad="ShowErrMsg()">
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">题库日志类型管理</div>
			...
			<div class="Course-Table">
				...
				<table class="table table-hover table-bordered"
					...
					<tbody>
						...
						<c:forEach var="dataitem" items="${pagedDatabaseLoggingType.result}">
							<tr>
								<th scope="row"><input type="checkbox" value="">
									${(pagedDatabaseLoggingType.currentPageNo-1) * pagedDatabaseLoggingType.pageSize +index}</th>
								<td>${dataitem.name}</td>
								<td>${dataitem.note}</td>
				...
				<mathtop:PageBar pageUrl="/${pagedURI}/list.html"
					pageAttrKey="pagedDatabaseLoggingType" />
			...
			<div class="modal-content">
				...
				<form class="form-signin" action="<c:url value="/${pagedURI}/add.html"/>"
					...
					<div class="modal-body">
						<h4 class="form-signin-heading">请输入新加考试类型名称</h4>
						<label for="inputname" class="sr-only">考试类型名称</label> <input
							type="text" id="inputname" class="form-control" name="name"
							placeholder="考试类型名称" required autofocus> <label
							for="inputnote" class="sr-only">考试类型描述</label> <input type="text"
