		...
		<div class="DocumentPageRightArea">
			...
			<div class="Course-Table">
				...
				<mathtop:PageBar pageUrl="/school/list.html"
					pageAttrKey="pagedReferenceTypeData" />
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" id="inputname" class="form-control"
								name="name" placeholder="资料类型名称" required autofocus>
						</div>
			...
			<div class="modal-content">
				...
				<form class="form-signin"
					...
					<div class="modal-body">
						...
						<label for="inputname" class="sr-only">资料类型名称</label> <input
							...
							value="" placeholder="资料类型名称" required autofocus> <label
							for="inputnote" class="sr-only">资料类型描述</label> <input type="text"
