	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<form class="form-horizontal" style="overflow: hidden;"
				action="<c:url value="/student/deletestudent-${selectedt_department_id }-${selectedt_department_id }-${selectedt_natural_class_id }-${selectedStudentViewData.student.id }.html"/>"
				method="post">
				...
				<input type="hidden" name="t_natural_class_id"
					value="${selectedt_natural_class_id }"> <input
					type="hidden" name="t_user_id"
					value="${selectedStudentViewData.user.id}"> <input
					type="hidden" name="pageNo" value="${selectedtpageNo}">
				...
				<div class="form-group">
					<label for="studentNum" class="col-sm-1 control-label">学号</label>
					<div class="col-md-3">
				...
				<div class="form-group">
				<div class="alert alert-danger" role="alert">警告！删除后该学生所有的信息都将被删除！</div>
					...
					<img id="imgObj" alt="验证码" onclick="changeImg()" name="verify"
						...
						<button type="button" class="btn btn-default btn-xs" onclick="changeImg()">换一张</button>
				</div>
