				...
				<div class="panel-heading" role="tab" id="headingReference">
					<h4 class="panel-title">
						...
						<a class="collapsed" data-toggle="collapse"
							data-parent="#accordion" href="#collapseReference"
							aria-expanded="false" aria-controls="collapseReference"> 课程资料</a>
					</h4>
				</div>
					...
					<div class="panel-body">
						<div class="list-group">
							...
							<c:if test="${sessionScope.USER_CONTEXT.teacher!=null}">
								<a
									href="coursereferencetype/list-${selectedCourseTeachingClassID}.html"
			...
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingHomework">
					<h4 class="panel-title">
						<span class="glyphicon glyphicon-tasks" aria-hidden="true"></span>
						<a class="collapsed" data-toggle="collapse"
							data-parent="#accordion" href="#collapseHomework"
				...
				<div id="collapseHomework"
					...
					<div class="panel-body">
						<div class="list-group">
							...
							<c:if test="${sessionScope.USER_CONTEXT.teacher!=null}">
								<a
									href="coursehomeworktype/list-${selectedCourseTeachingClassID}.html"
									class="list-group-item <%=coursenav((String) session.getAttribute("nav"),
			...
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingDiscuss">
					<h4 class="panel-title">
						...
						<a class="collapsed" data-toggle="collapse"
							data-parent="#accordion" href="#collapseDiscuss"
			...
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingAtendance">
					<h4 class="panel-title">
						...
						<a class="collapsed" data-toggle="collapse"
							data-parent="#accordion" href="#collapseAtendance"
							aria-expanded="false" aria-controls="collapseAtendance"> 课程考勤</a>
					</h4>
				</div>
				<div id="collapseAtendance"
					class="panel-collapse collapse <%=iscourseCollapse((String) session.getAttribute("nav"), "courseattendancetype")%>"
					...
					<div class="panel-body">
						<div class="list-group">
							...
							<c:if test="${sessionScope.USER_CONTEXT.teacher!=null}">
								<a
									href="courseattendancetype/list-${selectedCourseTeachingClassID}.html"
									class="list-group-item <%=coursenav((String) session.getAttribute("nav"),
			...
			<div class="panel panel-default">
				...
				<div id="collapseMailBox"
					...
					<div class="panel-body">
						<div class="list-group">
							<a
								href="mailbox/receivedlistwithcourse-${selectedCourseTeachingClassID}.html"
