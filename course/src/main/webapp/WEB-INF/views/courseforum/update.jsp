...
<body>
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">修改${selectedCourseTeachingClassViewData.courseTeachingClass.name}论坛主题</div>
			...
			<div class="Course-Table">
				...
				<form
					action="<c:url value="/courseforum/update-${selectedCourseTeachingClassID}-${selectedCourseForumTopicViewData.forumtopic.id}.html"/>"
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="name" class="control-label">标题</label> <input
								...
								value="${selectedCourseForumTopicViewData.forumtopic.title}"
