...
<body class="home" onLoad="ShowErrMsg()">
	...
	<div class="DocumentPage">
		...
		<div class="DocumentPageRightArea">
			...
			<div class="CourseContentHeader">修改${selectedCourseTeachingClassViewData.teachingclass.name}论坛
			<blockquote>${selectedCourseReplyTopicViewData.forumreply.title}</blockquote>
</div>
			...
			<div class="Course-Table">
				...
				<form
					action="<c:url value="/courseforumreply/update-${selectedCourseTeachingClassID}-${selectedCourseForumTopicViewData.forumtopic.id}-${selectedCourseReplyTopicViewData.forumreply.id}.html"/>"
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="name" class="control-label">标题</label> <input
								type="text" id="name" class="form-control" name="title" value="${selectedCourseReplyTopicViewData.forumreply.title}"
...
//	var sHTML=${selectedCourseForumTopicViewData.forumtopic.content};
	...
	$('.summernote').code('${selectedCourseReplyTopicViewData.forumreply.content}');
	//	$("#contentDiv").code("adf");
