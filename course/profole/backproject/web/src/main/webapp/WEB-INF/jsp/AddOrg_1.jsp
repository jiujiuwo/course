...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="main">
            ...
            <div class="orgmiddle">
                 <form action="addorg.htm" method="post" commandName="org">
                    <div class="orgbiankuang">
                        <div class="orgzhongc">
<!--                                       	<div class="adneid">商户id：</div>
                                            <div class="adneio"><input  id="dealerid" name="dealerid" type="text" style="margin:7px 5px; width:130px;" /></div>-->
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            ...
                                            for (var i = 0; i < data.length; i++) {
                                                ...
                                                var orgname = showData.orgname
                                                $("#parent").append("<option value='" + parent + "'>" + orgname + "</option>");
                                            }
                                        });
                                    </script>
...
<!--                            <div class="adneid">是否法人机构：</div>
                            ...
                            <div class="adneio"><input type="text" path="tel" name="tel" id="tel" style="margin:7px 5px; width:130px;" jvpattern="^1[3|4|5|8][0-9]\d{4,8}$" jverrortip="填写正确联系方式（移动电话号码）." jvtipid="spt_tel"/>
                                <span id="spt_tel" ></span></div>
                            <div class="adneid">其他信息：</div>
                            <div class="adneit"><input type="text" path="other" name="other" id="other" style="margin:7px 5px; width:130px;" jvpattern="^[\u4E00-\u9FA5]{7,300}$" jverrortip="其他信息字数介于7~300个字数之间." value="其他信息默认为空" jvtipid="spt_other"/>
                                <span id="spt_other" ></span></div>-->
                        </div>
                        <div class="altbutton">
                            <input type="submit" name="button" id="button" style="width:70px; height:20px; border:1px #666 solid; border-radius:10px; float:left;" value="添加" />
