         ...
         var str=" <div class='btn'><input name='input' type='button' style='margin-left:20px;' value='确认' /><input name='input' type='button' style='margin-left:20px;' value='重置' /></div>"+
            ...
            for (var i = 0; i <data.length; i++) {
                ...
                var name=showData.name;
                 str = str + "<div class='wenzic'><input type='checkbox' name='tag2' value='" + stdNum + "' id='CheckboxGroup1_0' />"  + stdNum+":"+name+"</td>"+
                            "<div class='btn'><a href='showItem.htm?stdNum=" + stdNum + "'><input name='t' type='button' style='margin-left:25px;' value='查看' /></a> " +
                            " <a href='changeTagtwo.htm?stdNum=" + stdNum + "'><input name='t' type='button' style='margin-left:20px;' value='确认' /></a> " +
                            " <a href='tagtwo.htm?stdNum=" + stdNum + "'><input name='t' type='button' style='margin-left:20px;' value='取消'/></a></div>";
            }
            $("#table").html(str);
        });
    </script>
...
<div>
  ...
  <form id="form2" name="form2" style="width:100%; float:left; margin-left:20px; " method="post" action="termtaggingtwo.htm">
