...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="main">
            ...
            <div class="altmiddle">
                <form action="adduser.htm" method="post" commandName="user">
...
<!--                            <div class="adneid">用户id：</div>
                            ...
                            <div class="adneit"><input type="text" path="company" name="company" id="company" jvpattern="^\S" jverrortip="机构名不能为空." jvtipid="spt_company"/>
    				 <span id="spt_company"  ></span>
                            </div>
                            ...
                            <div class="adneit"><input type="text" path="password" name="password" id="password" style="margin:7px 5px; width:130px;" jvpattern="^\S" jverrortip="密码不能为空。" jvtipid="spt_password"/>
                            ...
                            <div class="adneit"><select type="text"  path="sex" name="sex" id="sex" style="margin:7px 5px; width:50px;" jvpattern="^\S" jverrortip="性别只能是男，女." jvtipid="spt_sex"/>
                                <option value="男">男</option>
                                <option value="女">女</option>
                                </select>
                                <span id="spt_sex"></span></div>
                            ...
                            <div class="adneio"><input type="text" path="thetitle" name="thetitle" id="thetitle" style="margin:7px 5px; width:130px;" jvpattern="^\S" jverrortip="职称不能为空." jvtipid="spt_thetitle"/>
                            ...
                            <div class="adneid">用户属性：</div>
                            <div class="adneio"><input type="text" path="attribute" name="attribute" id="attribute" style="margin:7px 5px; width:130px;" jvpattern="^\S" jverrortip="用户属性不能为空." jvtipid="spt_attribute"/>
                                <span id="spt_attribute" ></span></div>
                            <div class="adneid">所在部门：</div>
                            <div class="adneit"><input type="text" path="department" name="department" id="department" style="margin:7px 5px; width:130px;" jvpattern="^\S" jverrortip="部门名称不能为空。" jvtipid="spt_department"/>
                                <span id="spt_department" ></span></div>
                            ...
                            <div class="adneid">固定电话号码：</div>
                            <div class="adneio"><input type="text"  path="mobile" name="mobile" id="mobile" style="margin:7px 5px; width:130px;" jvpattern="^(\d{3,4}\-?)?\d{7,8}$" jverrortip="号码格式如下（****-*******）." jvtipid="spt_mobile"/>
