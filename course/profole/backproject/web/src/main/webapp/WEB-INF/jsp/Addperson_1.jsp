                    ...
                    <div class="altbiankuang">
                        <div class="altzhongc">
                            ...
                            <div class="adneit"><select type="text" path="company" name="company" id="company"
                                ...
                                <input type="text" path="bucompany" name="bucompany" id="bucompany" value="选项中没有则在此处填写"/>
                            </div>
...
<!--                            <div class="adneid">出生日期：</div>
                            ...
                            <div class="adneit"><input type="text" path="position" name="position" id="position" style="margin:7px 5px; width:130px;" jvpattern="^\S" jverrortip="职务不能为空." jvtipid="spt_position"/>*
                            ...
                            <div class="adneio">
                                <!--                                <input type="text" path="attribute" name="attribute" id="attribute" style="margin:7px 5px; width:130px;" jvpattern="^\S" jverrortip="用户属性不能为空." jvtipid="spt_attribute"/>
                                                                <span id="spt_attribute" ></span></div>-->
                                <select type="text"  path="attribute" name="attribute" id="attribute" style="margin:7px 5px; width:80px;" jvpattern="^\S" jverrortip="请选用户角色" jvtipid="spt_attribute"/>*
